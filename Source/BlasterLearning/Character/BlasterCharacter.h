...
public:
	...
	virtual void GetLifetimeReplicatedProps(TArray<FLifetimeProperty>& OutLifetimeProps) const override;//复制
...
protected:
	...
	void FireButtonPressed();//按下开火键
	void FireButtonReleased();//何时开火
...
private:
	UPROPERTY(VisibleAnyWhere, Category = Camera)//弹簧臂
	...
	class AWeapon* OverlappingWeapon;//这个就是武器，也是EquippedWeapon 在combatcomponent.h ，当然OverlappingWeapon可能指向第二把武器

	UFUNCTION()
	void OnRep_OverlappingWeapon(AWeapon* LastWeapon);

	UFUNCTION(Server, Reliable)
	void ServerEquipButtonPressed();//客户端也需要拾起武器 其实就是ServerEquipButtonPressed_Implementation()
	...
	*/
	...
	class UCombatComponent* Combat;//声明了一个指针变量
